...
public class Reporte2 extends javax.swing.JFrame {
    ...
    public Reporte2() {
        ...
        crea.addTableHeaderRep2(model,jTable_reporte);
        viewSQL.Reporte2(jTable_reporte);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(boton_Volver_Sintomas, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 250, 80, 27));
        ...
        jTable_reporte.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Vacuna", "Porcentaje contagios pos vacuna"
            }
        ) {
        ...
        title_RegistroSintomas1.setText("Eficacia de cada vacuna con respecto al nivel de contagio");
