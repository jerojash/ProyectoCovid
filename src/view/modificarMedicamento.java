...
public class modificarMedicamento extends javax.swing.JFrame {
     ...
     */
    public modificarMedicamento(String codmedicamento, String nombre, String compuesto, String concentracion) {
        initComponents();
        this.codmedicamento = codmedicamento;
        title_medicamento.setText("Modificar medicamento  Código: "+this.codmedicamento);
        field_NombreMed.setText(nombre);
        field_Concentracion.setText(concentracion);
        field_Compuesto.setText(compuesto);
    ...
    private void initComponents() {
        ...
        title_medicamento.setText("Modificar medicamento  Código: ");
    ...
    private void boton_Siguiente_RegistroMedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_Siguiente_RegistroMedActionPerformed
        ...
        if((veri.dataNB(field_NombreMed))&&(veri.dataNB(field_Concentracion))&&(veri.dataNB(field_Compuesto))){
            if((veri.noVacio(field_NombreMed.getText().toString()))&&(veri.noVacio(field_Concentracion.getText().toString()))&&(veri.noVacio(field_Compuesto.getText().toString()))){
                ...
                if (insertSQL.modificarMedicamento(codmedicamento, field_NombreMed, field_Compuesto,field_Concentracion)){
                    JOptionPane.showMessageDialog(null, "Medicamento modificado con exito");
                    RegistroVisualizacionMedicamento medicamento = new RegistroVisualizacionMedicamento();
                    creaInterfaz.InterfazDiferentes(this, medicamento, 1008, 420);
                }
