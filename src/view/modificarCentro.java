...
public class modificarCentro extends javax.swing.JFrame {
    ...
    public modificarCentro(String cod, String nombre, String Direccion, String Pais, String Estado, String encargado, String fechaEncargo, String tipoCentro) {
        initComponents();
        this.cod = cod;
        this.setSize(543,650);
        this.setResizable(false);
        title_CentroSalud.setText("Modificar centro de salud: "+cod);
        field_nombreCentro1.setText(nombre);
        field_direccionCentro.setText(Direccion);
        label_Pais.setText("País: " + Pais);
        label_Estado.setText("Estado: " + Estado);
        label_MedicoE.setText("Cedula encargado: "+encargado);
        label_Fecha_Origen.setText("Fecha encargo: "+fechaEncargo);
        //label_TipoCentro.setText("Tipo de centro: "+tipoCentro);
    ...
    private void initComponents() {
        ...
        jPanel1.add(boton_Aceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 560, 80, 27));
        ...
        jPanel1.add(boton_Volver_RegistroCentro, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 560, 80, 27));
        ...
        label_Pais.setText("País: Venezuela");
        jPanel2.add(label_Pais, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, -1, -1));
        ...
        jPanel2.add(label_TipoCentro, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 390, -1, -1));

        label_MedicoE.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        label_MedicoE.setText("Médico encargado: Daniel Rojas");
        ...
        label_Estado.setText("Estado: Miranda");
        jPanel2.add(label_Estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, -1, -1));
        ...
        jPanel2.add(desplegable_Pais, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 110, 180, -1));
        ...
        jPanel2.add(desplegable_TipoCentro, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 390, 180, -1));
        ...
        jPanel2.add(desplegable_MedicoE, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 250, 180, -1));

        label_Fecha_Origen.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        label_Fecha_Origen.setText("Fecha de Encargo:  31/07/22");
        jPanel2.add(label_Fecha_Origen, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, -1, -1));

        calendario.setFont(new java.awt.Font("Serif", 0, 14)); // NOI18N
        jPanel2.add(calendario, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 340, 180, 30));
        ...
        jPanel2.add(desplegable_Estado1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 180, -1));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(29, 57, 450, 470));

        title_CentroSalud.setFont(new java.awt.Font("Forte", 0, 24)); // NOI18N
        title_CentroSalud.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        title_CentroSalud.setText("Modificar centro de salud: ");
        jPanel1.add(title_CentroSalud, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, 410, 40));
    ...
    private void boton_AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_AceptarActionPerformed
        ...
        if((veri.dataNB(field_nombreCentro1))&&(veri.dataNB(field_direccionCentro))){
            if((veri.noVacio(field_direccionCentro.getText().toString()))&&(veri.noVacio(field_nombreCentro1.getText().toString()))){
                    ...
                    if (insertSQL.modificarCentroSalud(desplegable_TipoCentro.getSelectedItem().toString(),cod, field_nombreCentro1,field_direccionCentro, desplegable_Estado1.getSelectedItem().toString(), desplegable_MedicoE.getSelectedItem().toString(),calendario)){
